        ...
        <div class="wrap_header">
            ...
            <div class="header-icons">
                <a href="#" class="header-wrapicon1 dis-block">
                    <img src="{{ asset('template/fashe/images/icons/icon-header-01.png') }}" class="header-icon1" alt="ICON">
                </a>

                <span class="linedivide1"></span>

                <div class="header-wrapicon2">
                    <img src="{{ asset('template/fashe/images/icons/icon-header-02.png') }}" class="header-icon1 js-show-header-dropdown" alt="ICON">
                            ...
                            <ul class="header-cart-wrapitem">
                                <li class="header-cart-item">
                                    <div class="header-cart-item-img">
                                        <img src="{{ asset('template/fashe/images/item-cart-01.jpg') }}" alt="IMG">
                                    </div>
                                ...
                                <li class="header-cart-item">
                                    <div class="header-cart-item-img">
                                        <img src="{{ asset('template/fashe/images/item-cart-03.jpg') }}" alt="IMG">
                                    </div>
