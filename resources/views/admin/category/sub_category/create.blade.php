...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Create Data Sub Category</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="box box-default color-palette-box">
            <div class="box-header with-border">
                <h3 class="box-title">Add Data Sub Category</h3>
            </div>
            <form role="form" class="form-horizontal" method="POST" action="{{ route('admin.sub_category.store', $category) }}">
                <div class="box-body">
                <div class="col-md-12">
